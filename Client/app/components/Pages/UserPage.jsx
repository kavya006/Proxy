...
class UserAdmin extends Component{
	...
	constructor(props) {
		...
		this.data = [];
		this.files = [];
		this.state = {showAdd : false, showAdv : false, showDelete : false, name : '', id : '', data : [], files: [], showPicsList: false, advancedID: '', loaded:true};
	...
	handleSubmitFinal(){
	    ...
	    $.ajax({
	      ...
	      success: function  (data2, text, req) {
	      	_this.files = [];
			_this.setState({showAdv : _this.state.showAdv ? false : true, advancedID: '', files: _this.files, loaded:true});
	      },
